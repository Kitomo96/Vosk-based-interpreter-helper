...
class RecognitionResult:
    ...
    def __init__(self, text: str, is_final: bool, confidence_scores: List[float] = None, 
        ...
        self.timestamp = timestamp or time.time() if 'time' in globals() else None
    ...
    def _recognition_loop(self, audio_manager) -> None:
        ...
        while not self.stop_event.is_set():
            try:
                ...
                for lang_code, recognizer in self.recognizers.items():
                    self._process_audio_for_language(audio_data, lang_code, recognizer)
